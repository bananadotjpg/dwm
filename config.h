...
static const char border_colour[] 	= "#FFFFFF";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { nord_white, nord_polar_darkest_blue, nord_dark_white},
	[SchemeSel]  = { nord_polar_darkest_blue, nord_frost_darker_light_blue,  nord_dark_white },
};
...
static const Layout layouts[] = {
	...
	{ ":D",      NULL },    /* no layout function means floating behavior */
	{ "[M]",      monocle },
};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_q,      spawn,          {.v = screenshotcmd } },
